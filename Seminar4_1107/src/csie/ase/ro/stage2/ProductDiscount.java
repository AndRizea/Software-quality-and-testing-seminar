...
public class ProductDiscount {
    ...
    public float getFinalPrice(ProductType productType, float initialPrice, int userAccountAge) {
        float finalPrice = 0;
        float accountDiscount = (userAccountAge > ACCOUNT_AGE_LIMIT_DISCOUNT) ? MAX_ACCOUNT_DISCOUNT_VALUE : (float) userAccountAge / 100;
